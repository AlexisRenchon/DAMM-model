...
function DAMM(Tsoil::Float64, Msoil::Float64; kMSx::Float64=1e-8, AlphaSx::Float64=1e8, kMO2::Float64=1e-3)::Float64 
...
# Need to add kwargs (optional arguments) for parameters!
