...
scene, layout = layoutscene(resolution = (900, 500));
...
texts[5] = LText(scene, text= lift(X->string(to_latex("S_x"), " = ", X, to_latex(" (g C cm^{-3})")), sliders[5].value), textsize=15, width = Auto(false));
